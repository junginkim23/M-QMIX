...
def get_config(algorithm, minigame, masking_ratio, anneal_time, t_max, seed, momentum):
    config_dir = '{0}/{1}'
    config_dir2 = '{0}/{1}/{2}'
    ...
    final_config_dict['masking_ratio'] = masking_ratio
    final_config_dict['t_max'] = t_max
    final_config_dict['epsilon_anneal_time'] = anneal_time
    final_config_dict['seed'] = seed
    final_config_dict['momentum'] = momentum
