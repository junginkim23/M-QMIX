...
class StarCraft2Env(MultiAgentEnv):
    ...
    def unit_max_shield(self, unit):
        ...
        if unit.unit_type == 83 or unit.unit_type == self.immortal_id:
            return 100  # Add Protoss's Immortal
    ...
    def get_unit_type_id(self, unit, ally):
        ...
        if ally:  # use new SC2 unit types
            ...
            # Add New Scenario
            elif self.map_type == 'zealots_stalkers_immortals':
                # id(Stalker) = 74, id(Zealot) = 73, id(Immortal) = 83
            ...
            # Add New Scenario
            elif self.map_type == 'zealots_immortals':
                # id(Zealot) = 73, id(Immortal) = 83
                if unit.unit_type == 83:
                    type_id = 0
    ...
    def _init_ally_unit_types(self, min_unit_type):
        ...
        # Add New scenario
            ...
            # FIXME: Ordering
            self.immortal_id = min_unit_type
            self.stalker_id = min_unit_type + 1
            self.zealot_id = min_unit_type + 2
        # Add New scenario
        elif self.map_type == 'zealots_immortals':
